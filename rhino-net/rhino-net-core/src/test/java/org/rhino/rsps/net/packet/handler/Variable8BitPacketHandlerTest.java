...
import org.rhino.rsps.net.packet.handler.impl.Variable8BitHeaderPacketReader;
...
public class Variable8BitPacketHandlerTest {
    ...
    private static final PacketHandler TEST_READER = new Variable8BitHeaderPacketReader();
