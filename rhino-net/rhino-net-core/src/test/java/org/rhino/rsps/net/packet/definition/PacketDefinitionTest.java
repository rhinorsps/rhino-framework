...
public class PacketDefinitionTest {
    ...
    public void testFixedLength() {
        ...
        Assert.assertEquals(TEST_OPCODE, definition.getExpectedOpcode());
        Assert.assertEquals(1, definition.getExpectedLength());
        Assert.assertEquals(PacketDefinition.HeaderType.FIXED_SIZE, definition.getHeaderType());
    }
    ...
    public void testVariableLength8Bit() {
        ...
        Assert.assertEquals(TEST_OPCODE, definition.getExpectedOpcode());
        Assert.assertEquals(-1, definition.getExpectedLength());
        Assert.assertEquals(PacketDefinition.HeaderType.VARIABLE_SIZE_8, definition.getHeaderType());
    }
    ...
    public void testVariableLength16Bit() {
        ...
        Assert.assertEquals(TEST_OPCODE, definition.getExpectedOpcode());
        Assert.assertEquals(-1, definition.getExpectedLength());
        Assert.assertEquals(PacketDefinition.HeaderType.VARIABLE_SIZE_16, definition.getHeaderType());
    }
